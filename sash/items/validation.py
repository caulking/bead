...
from sash.items.models import Item, ItemTemplate, ModelOutput
...
def validate_metadata_completeness(item: Item) -> list[str]:
    ...
    Since Item inherits from SashBaseModel, id, created_at, and modified_at
    ...
    # Check base model fields (from SashBaseModel)
