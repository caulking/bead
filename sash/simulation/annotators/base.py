...
class SimulatedAnnotator(ABC):
    ...
    def from_config(cls, config: SimulatedAnnotatorConfig) -> SimulatedAnnotator:
        ...
        from sash.simulation.annotators.distance_based import (  # noqa: PLC0415
            DistanceBasedAnnotator,
        )
        from sash.simulation.annotators.lm_based import (  # noqa: PLC0415
            LMBasedAnnotator,
        )
        from sash.simulation.annotators.oracle import OracleAnnotator  # noqa: PLC0415
        from sash.simulation.annotators.random import RandomAnnotator  # noqa: PLC0415
