...
This module provides functionality for serializing SashConfig objects to YAML format,
...
def config_to_dict(
    config: SashConfig, include_defaults: bool = False
) -> dict[str, Any]:
    """Convert SashConfig to dictionary for YAML serialization.
...
def to_yaml(config: SashConfig, include_defaults: bool = False) -> str:
