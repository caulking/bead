...
from sash.training.active_learning.strategies import create_strategy
...
class UncertaintySampler(ItemSelector):
    ...
    active learning in SASH.

    Parameters
    ----------
    method : Literal["entropy", "margin", "least_confidence"]
        Uncertainty quantification method to use.
    batch_size : int
    ...
    def __init__(
        ...
        self.strategy = create_strategy(method)
