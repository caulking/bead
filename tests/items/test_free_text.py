...
class TestCreateFreeTextItem:
    ...
    def test_empty_prompt_raises_error(self) -> None:
        ...
        with pytest.raises((ValueError, dx.ValidationError), match="prompt is required"):
    ...
    def test_invalid_length_constraints_raise_error(self) -> None:
        ...
        with pytest.raises((ValueError, dx.ValidationError), match="min_length.*cannot be greater than"):
            create_free_text_item(
