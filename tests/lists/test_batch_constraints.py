...
class TestBatchCoverageConstraint:
    ...
    def test_create_without_target_values(self) -> None:
        ...
        constraint = BatchCoverageConstraint(constraint_type="coverage", property_expression="item['verb']",
            target_values=None,
        )
    ...
    def test_property_expression_validation_empty(self) -> None:
        ...
        with pytest.raises(ValidationError) as exc_info:
            BatchCoverageConstraint(constraint_type="coverage", property_expression="",
                target_values=list(range(10)),
            )
    ...
    def test_property_expression_strips_whitespace(self) -> None:
        ...
        constraint = BatchCoverageConstraint(constraint_type="coverage", property_expression="  item['test']  ",
            target_values=[1, 2, 3],
        )
    ...
    def test_min_coverage_validation_negative(self) -> None:
        ...
        with pytest.raises(ValidationError) as exc_info:
            BatchCoverageConstraint(constraint_type="coverage", property_expression="item['test']",
                target_values=[1, 2, 3],
                min_coverage=-0.1,
            )
...
class TestBatchBalanceConstraint:
    ...
    def test_property_expression_validation_empty(self) -> None:
        """Test empty property_expression raises ValidationError."""
        with pytest.raises(ValidationError) as exc_info:
            BatchBalanceConstraint(constraint_type="balance", property_expression="",
                target_distribution={"A": 0.5, "B": 0.5},
            )
        assert "must be non-empty" in str(exc_info.value)
    ...
    def test_tolerance_validation_negative(self) -> None:
        ...
        with pytest.raises(ValidationError) as exc_info:
            BatchBalanceConstraint(constraint_type="balance", property_expression="item['test']",
                target_distribution={"A": 0.5, "B": 0.5},
                tolerance=-0.1,
            )
        assert "greater than or equal to 0" in str(exc_info.value)
    ...
    def test_target_distribution_validation_sum_valid_range(self) -> None:
        ...
        constraint = BatchBalanceConstraint(constraint_type="balance", property_expression="item['test']",
...
class TestBatchDiversityConstraint:
    ...
    def test_create_basic(self) -> None:
        ...
        constraint = BatchDiversityConstraint(constraint_type="diversity", property_expression="item['verb_lemma']",
    ...
    def test_property_expression_validation_empty(self) -> None:
        """Test empty property_expression raises ValidationError."""
        with pytest.raises(ValidationError) as exc_info:
            BatchDiversityConstraint(constraint_type="diversity", property_expression="",
                max_lists_per_value=3,
            )
        assert "must be non-empty" in str(exc_info.value)
    ...
    def test_max_lists_per_value_validation_one(self) -> None:
        ...
        constraint = BatchDiversityConstraint(constraint_type="diversity", property_expression="item['test']",
            max_lists_per_value=1,
        )
...
class TestBatchMinOccurrenceConstraint:
    ...
    def test_property_expression_validation_empty(self) -> None:
        """Test empty property_expression raises ValidationError."""
        with pytest.raises(ValidationError) as exc_info:
            BatchMinOccurrenceConstraint(constraint_type="min_occurrence", property_expression="",
                min_occurrences=10,
            )
        assert "must be non-empty" in str(exc_info.value)
    ...
    def test_min_occurrences_validation_one(self) -> None:
        ...
        constraint = BatchMinOccurrenceConstraint(constraint_type="min_occurrence", property_expression="item['test']",
            min_occurrences=1,
        )
